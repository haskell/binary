...
-- higher level ones using the Binary class
        ...
        ,("Maybe Int8", property (roundTrip :: Maybe Int8 -> Bool))
        ,("Either Int8 Int16", property (roundTrip :: Either Int8 Int16 -> Bool))
        ,("(Int32, [Int])", property (roundTrip :: (Int32, [Int]) -> Bool))
        ,("(Maybe Int64, Bool, [Int])", property (roundTrip :: (Maybe Int64, Bool, [Int]) -> Bool))
        ,("(Maybe Word8, Bool, [Int], Either Bool Word8)", property (roundTrip :: (Maybe Word8, Bool, [Int], Either Bool Word8) -> Bool))
{-        ,("(Maybe Word16, Bool, [Int], Either Bool Word16, Int)", property (roundTrip :: (Maybe Word16, Bool, [Int], Either Bool Word16, Int) -> Bool))
        ,("(Maybe Word32, Bool, [Int], Either Bool Word32, Int, Int)", property (roundTrip :: (Maybe Word32, Bool, [Int], Either Bool Word32, Int, Int) -> Bool))
        ,("(Maybe Word64, Bool, [Int], Either Bool Word64, Int, Int, Int)", property (roundTrip :: (Maybe Word64, Bool, [Int], Either Bool Word64, Int, Int, Int) -> Bool))-}
        ...
        ,("Set Word32",      property (roundTrip :: Set.Set Word32 -> Bool))
        ,("Map Word16 Int",  property (roundTrip :: Map.Map Word16 Int -> Bool))
